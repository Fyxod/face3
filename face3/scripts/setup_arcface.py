...
from face3.models.arcface import ArcFaceIResNet100, sha256_file, write_setup_report


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Setup/validate ArcFace iResNet-100 checkpoint for face3.")

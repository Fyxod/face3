"""Generate visible sample strips for individual FACE3 perturbation families.
...
def _resolve_images(root: Path, faces: list[str], explicit_image: str | None) -> dict[str, Path]:
    ...
    if not resolved:
        raise FileNotFoundError(
            "No sample images found. Expected MAT data beside this repo or existing FACE3 output originals. "
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Generate FACE3 individual perturbation sample strips.")
